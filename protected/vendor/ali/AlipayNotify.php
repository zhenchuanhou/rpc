...
use frontend\component\AlipayCore;
use frontend\component\AlipayMD5;
use frontend\component\AliwappayRsa;
    ...
    function getSignVeryfy($para_temp, $sign) {
        ...
        switch (strtoupper(trim($this->alipay_config['sign_type']))) {
            case "MD5" :
                ...
                break;
            case "RSA" :
                $isSgin = AliwappayRsa::rsaVerify($prestr, trim($this->alipay_config['ali_public_key_path']), $sign);
                break;
            default :
                $isSgin = false;
        }
