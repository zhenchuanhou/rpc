...
class EmailManager
{
    ...
    public function sendEmailSalesOrderPaid($data)
    {
        ...
        $booking = $this->arrayToObject($data['booking']);
        $order = $this->arrayToObject($data['salesOrder']);
        unset($data);
        //modify by wanglei RPC
        $data = new stdClass();
    ...
    {
        //modify by wanglei RPC
        // public function sendEmailQuickBooking($id) {
     ...
     */
    //modify by wanglei RPC
    public function sendEmailAppBooking($id, $vender = NULL)
    {
        $model = Booking::model()->getByid($id);
        $view = 'appBookingNew';
        ...
        $from = array('314551195@qq.com' => Yii::app()->name);
    ...
    {
        //public function sendEmailEnquiry($id) {
        //$model= ContactEnquiry::model()->getById($id);
        // $modelarray=CJSON::decode($modeljson);

        //$model=$this->arrayToObject($modelarray);
    ...
    //modify by wanglei  RPC 2016-07-30
    // public function sendEmailContactUs(Contactus $contactus) {
    public function sendEmailContactUs($contactus)
    {
        $contactus = CJSON::decode($contactus);
        $contactus = $this->arrayToObject($contactus);
        $view = 'siteContactUs';
    ...
    public function sendEmail($sender, array $recipients, $subject, $bodyParams, $view)
    {
        $count = 0;
    ...
    public function sendEmailMessageQueue($id)
    {
        $msgqueue = MessageQueue::model()->getById($id);
